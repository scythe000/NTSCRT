...
mod tests {
    ...
    fn a_broken_png_reports_the_image_error_not_ffmpeg() {
        let dir = std::env::temp_dir().join(format!("vhs-studio-broken-{}", std::process::id()));
    ...
    fn png_round_trips_through_disk() {
        ...
        let path = dir.join("vhs-studio-io-test.png");
    ...
    fn save_rejects_a_mismatched_buffer() {
        let path = std::env::temp_dir().join("vhs-studio-io-bad.png");
