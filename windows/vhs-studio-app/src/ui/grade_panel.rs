//! Colour panel: the controls of the grade stage (`vhs_studio_core::grade`).
//!
...
use eframe::egui;
use vhs_studio_core::{grade_param, GRADE_PARAMS};

use crate::app::VhsStudioApp;

pub fn show(app: &mut VhsStudioApp, ui: &mut egui::Ui) {
...
fn controls(app: &mut VhsStudioApp, ui: &mut egui::Ui) {
...
/// is picked.
fn hue_row(ui: &mut egui::Ui, app: &VhsStudioApp, changes: &mut Vec<(&'static str, f32)>) {
...
mod tests {
    ...
    fn pure_red_reads_as_the_reference_hue() {
        // The colour-highlight test in vhs-studio-core uses this angle for red.
