...
impl VideoState {
    ...
    fn stamp(&self, downscale: Option<ntscrt_core::DownscaleSpec>) -> Stamp {
...
pub(crate) fn chain_input_size(
    source: (u32, u32),
    downscale: Option<ntscrt_core::DownscaleSpec>,
) -> (u32, u32) {
    ntscrt_core::ScanlineGrid::chain_input_size(source.0, source.1, downscale.as_ref())
}

#[cfg(test)]
mod tests {
    use super::*;
    use ntscrt_core::{DownscaleMethod, DownscaleSpec};
